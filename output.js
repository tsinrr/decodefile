//1/16/2025, 4:19:47 PM
//Project:https://github.com/dream385/decode
!function () {
  function I(I) {
    for (var KK = 5; 0 !== KK;) switch (KK % 10) {
      case 0:
        {
          !function (_a_r_g_, rK) {
            switch (rK) {
              case 0:
                {
                  return i < 64 ? KK = 70 : KK = 3;
                }
              case 1:
                {
                  return i < eK ? KK = 6 : KK = 90;
                }
              case 2:
                {
                  return i < sK ? KK = 31 : KK = 2;
                }
              case 3:
                {
                  uK = -uK;
      ...
      case 6:
        {
          ...
          switch (qK = rK[EK], 127 & qK) {
            ...
            case 118:
              {
                ...
                jK |= (bK >> 0 & 7) << 2;
                try {
                  31 === _K ? CK[AK] = CK[gK](CK[jK]) : CK[AK] = CK[_K][CK[gK]](CK[jK]);
                } catch (I) {
                  yK = !0;
                  if (0 == (EK = pK.pop())) {
                    break;
                  ...
                  -1 === EK && (EK = pK.pop());
                  2 === hK && (hK = pK.pop(), -1 === (EK = pK.pop()) && (sK.pop(), EK = pK.pop()));
                  dK = 3 + hK;
                  hK = (hK + 1) % 3;
                  CK[0] = I;
                }
            ...
            case 54:
              {
                ...
                gK = qK >> 17 & 31;
                try {
                  31 === _K ? CK[AK] = CK[gK]() : CK[AK] = CK[_K][CK[gK]]();
                } catch (I) {
                  yK = !0;
                  if (0 == (EK = pK.pop())) {
                    break;
            ...
            case 38:
              {
                AK = qK >> 7 & 31;
                _K = qK >> 12 & 255;
                2 == _K ? CK[AK] = +CK[AK] : 0 == _K ? CK[AK] = {} : 1 == _K ? CK[AK] = [] : CK[AK] = 0;
                break;
              }
            case 6:
              {
            ...
            case 106:
              {
                ...
                EK = pK.pop();
                hK = pK.pop();
                dK > 3 && -1 === (EK = pK.pop()) && (sK.pop(), EK = pK.pop());
                dK = 0;
                break;
              }
            case 61:
            ...
            case 50:
              {
                ...
                try {
                  if (0 === vK) {
                    31 === _K ? CK[AK] = CK[gK](CK[jK], CK[mK], CK[QK], CK[MK]) : CK[AK] = CK[_K][CK[gK]](CK[jK], CK[mK], CK[QK], CK[MK]);
                  } else {
                    for (aK = [], 31 == _K ? cK = 0 : cK = CK[_K], aK.push(CK[jK]), aK.push(CK[mK]), aK.push(CK[QK]), aK.push(CK[MK]), uK = [], i = 0; i < vK; i++) uK.push(sK.pop());
                    for (i = 0; i < vK; i++) aK.push(uK.pop());
                    31 == _K ? CK[AK] = CK[gK].apply(cK, aK) : CK[AK] = cK[CK[gK]].apply(cK, aK);
                    vK = 0;
                  }
                } catch (I) {
                  yK = !0;
            ...
            case 82:
              {
                ...
                QK = bK >> 8 & 31;
                try {
                  31 === _K ? CK[AK] = CK[gK](CK[jK], CK[mK], CK[QK]) : CK[AK] = CK[_K][CK[gK]](CK[jK], CK[mK], CK[QK]);
                } catch (I) {
                  yK = !0;
                  if (0 == (EK = pK.pop())) {
                    break;
            ...
            case 18:
              {
                ...
                mK = bK >> 3 & 31;
                try {
                  31 === _K ? CK[AK] = CK[gK](CK[jK], CK[mK]) : CK[AK] = CK[_K][CK[gK]](CK[jK], CK[mK]);
                } catch (I) {
                  yK = !0;
                  if (0 == (EK = pK.pop())) {
                    break;
            ...
            case 124:
              {
                if (xK = 1, bK = rK[EK + 1], AK = qK >> 7 & 65535, AK = AK << 16 >> 16, _K = qK >> 23 & 1, _K |= (bK >> 0 & 15) << 1, sK.length <= AK) {
                  break;
                }
            ...
            case 92:
              {
                for (AK = qK >> 7 & 255, i = 0; i < AK; i++) sK.push(iK.pop());
                break;
              }
            case 60:
              {
                if (AK = qK >> 7 & 31, _K = qK >> 12 & 31, sK.length <= CK[_K]) {
                  break;
                }
            ...
            case 108:
              {
                for (xK = 1, bK = rK[EK + 1], AK = qK >> 7 & 65535, _K = qK >> 23 & 1, _K |= (bK >> 0 & 32767) << 1, i = 1; i <= _K; i++) kK(AK + _K - i, sK.pop());
                break;
              }
            case 28:
              {
                if (xK = 1, bK = rK[EK + 1], AK = qK >> 7 & 31, _K = qK >> 12 & 4095, _K |= (bK >> 0 & 15) << 12, _K = _K << 16 >> 16, sK.length <= _K) {
                  break;
                }
            ...
            case 116:
              {
                AK = qK >> 7 & 31;
                _K = qK >> 12 & 31;
                CK[AK] && (yK = !0, EK = CK[_K] - 1);
                break;
              }
            case 84:
              {
                for (xK = 1, bK = rK[EK + 1], AK = qK >> 7 & 65535, _K = qK >> 23 & 1, _K |= (bK >> 0 & 32767) << 1, i = 0; i < _K; i++) sK.push(oK(AK + i));
                break;
              }
            case 100:
              {
            ...
            case 48:
              {
                if (AK = qK >> 7 & 31, _K = qK >> 12 & 31, gK = qK >> 17 & 31, 0 === CK[AK]) {
            ...
            case 80:
              {
                if (AK = qK >> 7 & 31, _K = qK >> 12 & 31, sK.length <= CK[AK]) {
                  break;
                }
            ...
            case 8:
              {
                if (xK = 1, bK = rK[EK + 1], AK = qK >> 7 & 31, _K = qK >> 12 & 4095, _K |= (bK >> 0 & 15) << 12, gK = bK >> 4 & 255, "number" == typeof CK[AK].jsvmfunc) {
                  for (i = 1; i <= gK; i++) lK.push(oK(_K + i));
                  TK = !0;
                  sK.push(oK(_K));
                  yK = !0;
                  sK.push(EK + 1 + xK);
                  ...
                  for (aK = [], cK = oK(_K), i = 0; i < gK; i++) aK.push(oK(_K + gK - i));
  ...
  function t() {
        ...
        _K = a.sesca = s.extend({
          _dret: function () {
            if (!this._nrr || this._kpr !== this._eyy) {
              for (var r = this._kpr = this._eyy, t = r.dw, n = r.sioj / 4, i = this._nrr = n + 6, s = this._ksl = [], a = 4 * (i + 1), c = 0; c < a; c++) if (c < n) {
                s[c] = t[c];
                var o;
              } else {
                var f,
    ...
    var r = r || function (r, t) {
      var n = Object.ctac || function () {
        ...
        e = s.Aydrsd = a.extend({
          gltr: function (r, n) {
            r = this.dw = r || [];
            0 != n ? this.sioj = n : this.sioj = 4 * r.length;
          },
          toString: function (r) {
          ...
          concat: function (r) {
            ...
            if (i % 4) {
              ...
              for (var a = 0; a < s; a += 4) t[i + a >>> 2] = n[a >>> 2];
            }
            this.sioj += s;
            return this;
          },
        ...
        o = c.lskdj = {
          ...
          parse: function (r) {
            for (var t = r.length, n = [], i = 0; i < t; i += 2) n[i >>> 3] |= parseInt(r.substr(i, 2), 16) << 24 - i % 8 * 4;
        ...
        f = c.Mjsuhf3 = {
          ...
          parse: function (r) {
            for (var t = r.length, n = [], i = 0; i < t; i++) n[i >>> 2] |= (255 & r.charCodeAt(i)) << 24 - i % 4 * 8;
            return new e.gltr(n, t);
          }
        },
        _ = c.Afts4 = {
        ...
        d = s.yhksjdb = a.extend({
          ...
          _fjui: function (t) {
            var n = this.dda,
              ...
              c = 4 * a,
              o = s / c;
            t ? o = r.ceil(o) : o = r.max((0 | o) - this.iunjks, 0);
            var f = o * a,
              _ = r.min(4 * f, s);
            if (f) {
              for (var d = 0; d < f; d += a) this.oiunxda(i, d);
              var v = i.splice(0, f);
              n.sioj -= _;
            }
    ...
    (function () {
      function e(r, t, n) {
        for (var s = [], a = 0, e = 0; e < t; e++) if (e % 4) {
      ...
      s.Ase4 = {
        stringify: function (r) {
          var t = r.dw,
            ...
            i = this._map;
          r.clamp();
          for (var s = [], a = 0; a < n; a += 3) for (var e = t[a >>> 2] >>> 24 - a % 4 * 8 & 255, c = t[a + 1 >>> 2] >>> 24 - (a + 1) % 4 * 8 & 255, o = t[a + 2 >>> 2] >>> 24 - (a + 2) % 4 * 8 & 255, f = e << 16 | c << 8 | o, _ = 0; _ < 4 && a + .75 * _ < n; _++) s.push(i.charAt(f >>> 6 * (3 - _) & 63));
          var d = i.charAt(64);
          if (d) {
            for (; s.length % 4;) s.push(d);
          }
          return s.join("");
        },
        parse: function (r) {
    ...
    r.lib.S_rhi || function (t) {
      var n = r,
        ...
        k = g.d6oipf = {
          pad: function (r, t) {
            for (var n = 4 * t, i = n - r.sioj % n, s = i << 24 | i << 16 | i << 8 | i, e = [], c = 0; c < i; c += 4) e.push(s);
            var o = a.ctac(e, i);
            r.concat(o);
          },
          unpad: function (r) {
        ...
        j = (i.Lcob_picrk = v.extend({
          ...
          tsdop: function () {
            ...
            this._mk && this._mk.__creator == i ? this._mk.gltr(this, t && t.dw) : (this._mk = i.call(n, this, t && t.dw), this._mk.__creator = i);
          },
        ...
        b = i.cndjn = s.extend({
          ...
          lgt: function (r, t, n, i) {
            ...
            return r.cdjor(n, i).zflei(t.oiunb);
          },
          _parse: function (r, t) {
        ...
        C = i.kmndsjh = b.extend({
          ...
          lgt: function (r, t, n, i) {
            ...
            i.ckv = s.ckv;
            return b.lgt.call(this, r, t, s.ckl, i);
          }
        });
    }();
    r.mk.Kdlf = function () {
